...
namespace hk
{
  ...
  */
  class HK_UTILITY_EXPORT IPluginManager
  {
  public:
    ...
    */
    virtual eRESULT
    loadPlugin(const String& _key) = 0;
    ...
    */
    virtual eRESULT
    unloadPlugin(const String& _key) = 0;
    ...
    */
    virtual Plugin*
    getPlugin(const String& _key) = 0;

  private:

    IPluginManager&
    operator=(const IPluginManager&) = delete;
  };
}